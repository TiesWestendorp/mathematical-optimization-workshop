...
Exercises:
 ...
 3. While minimizing waste, we favoured overproducing finals over creating waste. This means that we probably often chose to produce according to the pattern with zero waste. In reality, however, overproduced finals of length 14 are considered waste as well. Alter your previous program to account for this.
